...
- [x] 6. Create hardware abstraction layer for transceiver communication
...
- [x] 10. Create embedded-optimized API and interfaces
- [x] 10.1 Design microcontroller-friendly API
...
- [x] 10.2 Implement position output formatting
